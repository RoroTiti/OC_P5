...
database = MySQLDatabase('pur_beurre', **{'charset': 'utf8', 'sql_mode': 'PIPES_AS_CONCAT', 'use_unicode': True, 'host': '192.168.1.230', 'port': 3306, 'user': 'pur_beurre', 'password': 'pur_beurre'})
